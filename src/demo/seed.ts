...
export function buildSeed(): DemoData {
  ...
  // Planes de suscripción de la plataforma (lo que paga cada gym a RF FIT).
  // Naming de marketing con narrativa de entrenamiento; los muestra la landing.
  const plans: SubscriptionPlan[] = [
    ...
    },
    {
      ...
      // El precio no se publica (customPricing) pero se conserva para el
      // orden por precio de listPlans.
      price: 50000,
      maxAdmins: 0,
      maxMembers: 0,
      maxRoutines: 0,
